...
Selecionei as perguntas mais recorrentes de quem abriu os precons pela primeira vez:
...
**Não.** Isso confunde muita gente vinda de Magic. A mana é incolor. O que existe é **threshold**: um requisito da carta verificado contra seus sites. Threshold não é "gasto" — é uma característica dos sites que precisa estar presente.

## 6. Posso colocar aura sobre aura?

**Sim.** Convivem normalmente.
...
*Tem mais dúvidas? Confira nosso [Glossário completo](/glossario) ou entre no [Discord da comunidade](https://discord.gg/qvYVGFAS5n).*
